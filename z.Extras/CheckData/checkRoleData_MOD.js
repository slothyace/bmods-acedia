...
module.exports = {
  ...
  subtitle: (values, constants, thisAction) =>{ // To use thisAction, constants must also be present
    ...
    return `Check If ${values.role}[${values.dataName}] ${phraseMap[values.comparisonType.type]} ${values.comparisonType.value}`
  },
  ...
  async run(values, message, client, bridge){ // This is the exact order of things required, other orders will brick
    ...
    let dataType = "roles"
    let retrieveObject = await bridge.getRole(values.role)
